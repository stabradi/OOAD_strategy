...
public class TestDeltaMovementValidation {
	DeltaMovementValidationStrategy validator;
	...
	@Before
	public void before(){
		validator = new DeltaMovementValidationStrategy();
	}
	...
	@Test(expected = StrategyException.class)
	public void testMoveOffBoard() throws StrategyException{
		Piece majorPiece = new Piece(PieceType.MAJOR, PlayerColor.RED);
		PieceLocationDescriptor major = new PieceLocationDescriptor(majorPiece, new BetaLocation2D(new Location2D(0,0)));
		List<PieceLocationDescriptor> configuration = new ArrayList<PieceLocationDescriptor>();
		configuration.add(major);
		...
		Location from = new Location2D(9,9);
		Location to = new Location2D(9,10);
		
		validator.validateMove(controller, configuration, major, from, to);
	}
	
	@Test
	public void testMoveToEdge() throws StrategyException{
		Piece majorPiece = new Piece(PieceType.MAJOR, PlayerColor.RED);
		PieceLocationDescriptor major = new PieceLocationDescriptor(majorPiece, new BetaLocation2D(new Location2D(0,0)));
		List<PieceLocationDescriptor> configuration = new ArrayList<PieceLocationDescriptor>();
		configuration.add(major);
		...
		Location from = new Location2D(8,8);
		Location to = new Location2D(8,9);
